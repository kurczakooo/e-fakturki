    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                ...
                {
                    "name": "NrVatUE",
                    "type": ForwardRef("Tpodmiot2.NrVatUe"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "KodKraju",
                ...
                {
                    "name": "NrID",
                    "type": ForwardRef("Tpodmiot2.NrId"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "BrakID",
    ...
    choice: list[
        ...
        metadata={
            ...
            "choices": (
                {
                    "name": "NIP",
                    "type": ForwardRef("Tpodmiot3.Nip"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "IDWew",
                    "type": ForwardRef("Tpodmiot3.Idwew"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "KodUE",
                ...
                {
                    "name": "NrVatUE",
                    "type": ForwardRef("Tpodmiot3.NrVatUe"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "KodKraju",
                ...
                {
                    "name": "NrID",
                    "type": ForwardRef("Tpodmiot3.NrId"),
                    "namespace": "http://crd.gov.pl/wzor/2025/06/25/13775/",
                },
                {
                    "name": "BrakID",
...
class Faktura:
    ...
    class Podmiot1:
        """
        Attributes:
            prefiks_podatnika: Kod (prefiks) podatnika VAT UE dla
    ...
    class Podmiot2:
        ...
        Attributes:
            ...
            adres: Adres nabywcy. Pola opcjonalne dla przypadków
            ...
            idnabywcy: Unikalny klucz powiązania danych nabywcy na
            ...
            jst: Znacznik jednostki podrzędnej JST. Wartość "1" oznacza,
                że faktura dotyczy jednostki podrzędnej JST. W takim
                przypadku, aby udostępnić fakturę jednostce podrzędnej
                JST, należy wypełnić sekcję Podmiot3, w szczególności
                podać NIP lub ID-Wew i określić rolę jako 8. Wartość "2"
                oznacza, że faktura nie dotyczy jednostki podrzędnej JST
            gv: Znacznik członka grupy VAT. Wartość "1" oznacza, że
                faktura dotyczy członka grupy VAT. W takim przypadku,
                aby udostępnić fakturę członkowi grupy VAT, należy
                wypełnić sekcję Podmiot3, w szczególności podać NIP lub
                ID-Wew i określić rolę jako 10. Wartość "2" oznacza, że
    ...
    class Podmiot3:
        ...
        Attributes:
            ...
            rola_or_rola_inna_or_opis_roli:
            udzial: Udział - procentowy udział dodatkowego nabywcy.
                Różnica pomiędzy wartością 100% a sumą udziałów
                dodatkowych nabywców jest udziałem nabywcy wymienionego
                w części Podmiot2. W przypadku niewypełnienia pola
                przyjmuje się, że udziały występujących na fakturze
                nabywców są równe
            nr_klienta: Numer klienta dla przypadków, w których podmiot
                wymieniony jako podmiot trzeci posługuje się nim w
        ...
        rola_or_rola_inna_or_opis_roli: list[TrolaPodmiotu3 | Twybor1 | str] = field(
            default_factory=list,
            metadata={
                "type": "Elements",
                "choices": (
    ...
    class PodmiotUpowazniony:
        ...
        Attributes:
            ...
            dane_identyfikacyjne: Dane identyfikujące podmiotu
                upoważnionego
    ...
    class Fa:
        ...
        Attributes:
            ...
            p_1: Data wystawienia, z zastrzeżeniem art. 106na ust. 1
                ustawy
            ...
            wz: Numery dokumentów magazynowych WZ (wydanie na zewnątrz)
                związane z fakturą
            p_6_or_okres_fa:
            p_13_1: Suma wartości sprzedaży netto objętej stawką
            ...
            p_14_1_w: W przypadku gdy faktura jest wystawiona w walucie
                ...
                faktur korygujących - kwota różnicy, o której mowa w
                art. 106j ust. 2 pkt 5 ustawy
            p_13_2: Suma wartości sprzedaży netto objętej stawką
            ...
            p_14_2: Kwota podatku od sumy wartości sprzedaży netto
                objętej stawką obniżoną pierwszą - aktualnie 8% albo 7%.
                W przypadku faktur zaliczkowych - kwota podatku
                wyliczona według wzoru, o którym mowa w art. 106f ust. 1
                pkt 3 ustawy. W przypadku faktur korygujących - kwota
            ...
            p_14_2_w: W przypadku gdy faktura jest wystawiona w walucie
                ...
                przepisami działu VI w związku z art. 106e ust. 11
                ustawy - aktualnie 8% albo 7%. W przypadku faktur
                zaliczkowych - kwota podatku wyliczona według wzoru, o
                którym mowa w art. 106f ust. 1 pkt 3 ustawy. W przypadku
                faktur korygujących - kwota różnicy, o której mowa w
                art. 106j ust. 2 pkt 5 ustawy
            p_13_3: Suma wartości sprzedaży netto objętej stawką
                obniżoną drugą - aktualnie 5%. W przypadku faktur
                zaliczkowych - wartość zaliczki netto. W przypadku
                faktur korygujących - kwota różnicy, o której mowa w
                art. 106j ust. 2 pkt 5 ustawy
            p_14_3: Kwota podatku od sumy wartości sprzedaży netto
                objętej stawką obniżoną drugą - aktualnie 5%. W
                przypadku faktur zaliczkowych - kwota podatku wyliczona
                według wzoru, o którym mowa w art. 106f ust. 1 pkt 3
                ustawy. W przypadku faktur korygujących - kwota różnicy,
                o której mowa w art. 106j ust. 2 pkt 5 ustawy
            p_14_3_w: W przypadku gdy faktura jest wystawiona w walucie
                ...
                przepisami działu VI w związku z art. 106e ust. 11
                ustawy - aktualnie 5%. W przypadku faktur zaliczkowych -
                kwota podatku wyliczona według wzoru, o którym mowa w
                art. 106f ust. 1 pkt 3 ustawy. W przypadku faktur
            ...
            p_13_5: Suma wartości sprzedaży netto w przypadku procedury
                ...
                różnicy, o której mowa w art. 106j ust. 2 pkt 5 ustawy
            p_14_5: Kwota podatku od wartości dodanej w przypadku
            ...
            p_13_6_1: Suma wartości sprzedaży objętej stawką 0% z
                wyłączeniem wewnątrzwspólnotowej dostawy towarów i
            ...
            p_13_6_2: Suma wartości sprzedaży objętej stawką 0% w
                przypadku wewnątrzwspólnotowej dostawy towarów. W
                przypadku faktur korygujących - kwota różnicy, o której
                mowa w art. 106j ust. 2 pkt 5 ustawy
            ...
            p_13_7: Suma wartości sprzedaży zwolnionej od podatku. W
                ...
                sprzedaży
            p_13_8: Suma wartości sprzedaży w przypadku dostawy towarów
            ...
            p_13_10: Suma wartości sprzedaży w procedurze odwrotnego
                ...
                odwrotnego obciążenia występujących w obrocie krajowym.
                W przypadku faktur zaliczkowych - wartość zaliczki. W
                przypadku faktur korygujących - kwota różnicy, o której
                mowa w art. 106j ust. 2 pkt 5 ustawy
            p_13_11: Suma wartości sprzedaży w procedurze marży, o
                której mowa w art. 119 i art. 120 ustawy. W przypadku
                faktur zaliczkowych - wartość zaliczki. W przypadku
                faktur korygujących - kwota różnicy wartości sprzedaży
            p_15: Kwota należności ogółem. W przypadku faktur
                ...
                korygowanej. W przypadku, o którym mowa w art. 106j ust.
                3 ustawy - korekta kwot wynikających z faktur
                korygowanych
            kurs_waluty_z: Kurs waluty stosowany do wyliczenia kwoty
                podatku w przypadkach, o których mowa w dziale VI ustawy
                na fakturach, o których mowa w art. 106b ust. 1 pkt 4
                ustawy
            ...
            okres_fa_korygowanej: Dla faktury korygującej, o której mowa
                w art. 106j ust. 3 ustawy - okres, do którego odnosi się
                udzielany opust lub udzielana obniżka, w przypadku gdy
                podatnik udziela opustu lub obniżki ceny w odniesieniu
                do dostaw towarów lub usług dokonanych lub świadczonych
                na rzecz jednego odbiorcy w danym okresie
            nr_fa_korygowany: Poprawny numer faktury korygowanej w
                przypadku, gdy przyczyną korekty jest błędny numer
                faktury korygowanej. W takim przypadku błędny numer
                faktury należy wskazać w polu NrFaKorygowanej
            podmiot1_k: W przypadku korekty danych sprzedawcy należy
                podać pełne dane sprzedawcy występujące na fakturze
                korygowanej. Pole nie dotyczy przypadku korekty błędnego
                NIP występującego na fakturze pierwotnej - wówczas
                wymagana jest korekta faktury do wartości zerowych
            podmiot2_k: W przypadku korekty danych nabywcy występującego
                jako Podmiot2 lub dodatkowego nabywcy występującego jako
                Podmiot3 należy podać pełne dane tego podmiotu
                występujące na fakturze korygowanej. Korekcie nie
                podlegają błędne numery NIP identyfikujące nabywcę oraz
                dodatkowego nabywcę - wówczas wymagana jest korekta
                faktury do wartości zerowych. W przypadku korygowania
                pozostałych danych nabywcy lub dodatkowego nabywcy
                wskazany numer identyfikacyjny ma być tożsamy z numerem
                w części Podmiot2 względnie Podmiot3 faktury korygującej
            p_15_zk: W przypadku korekt faktur zaliczkowych - kwota
                zapłaty przed korektą. W przypadku korekt faktur, o
                których mowa w art. 106f ust. 3 ustawy - kwota pozostała
                do zapłaty przed korektą
            kurs_waluty_zk: Kurs waluty stosowany do wyliczenia kwoty
                podatku w przypadkach, o których mowa w dziale VI ustawy
                przed korektą
            zaliczka_czesciowa: Dane dla przypadków faktur
                dokumentujących otrzymanie więcej niż jednej płatności,
                o której mowa w art. 106b ust. 1 pkt 4 ustawy. W
                przypadku, gdy faktura, o której mowa w art. 106f ust. 3
                ustawy dokumentuje jednocześnie otrzymanie części
                zapłaty przed dokonaniem czynności, różnica kwoty w polu
                P_15 i sumy poszczególnych pól P_15Z stanowi kwotę
                pozostałą ponad płatności otrzymane przed wykonaniem
                czynności udokumentowanej fakturą
            fp: Faktura, o której mowa w art. 109 ust. 3d ustawy
            tp: Istniejące powiązania między nabywcą a dokonującym
                ...
                podatkowych i w ewidencji w zakresie podatku od towarów
                i usług
            dodatkowy_opis: Pola przeznaczone dla wykazywania
                dodatkowych danych na fakturze, w tym wymaganych
                przepisami prawa, dla których nie przewidziano innych
                pól/elementów
            faktura_zaliczkowa: Numery faktur zaliczkowych lub ich
            ...
            fa_wiersz: Szczegółowe pozycje faktury w walucie, w której
                ...
                faktur korygujących dotyczących wszystkich dostaw
                towarów lub usług dokonanych lub świadczonych w danym
                okresie, o których mowa w art. 106j ust. 3 ustawy, dla
                których należy podać dane dotyczące opustu lub obniżki w
                podziale na stawki podatku i procedury w części Fa. W
                przypadku faktur korygujących, o których mowa w art.
                106j ust. 3 ustawy, gdy opust lub obniżka ceny odnosi
                się do części dostaw towarów lub usług dokonanych lub
                świadczonych w danym okresie w części FaWiersz należy
                podać nazwy (rodzaje) towarów lub usług objętych
                korektą. W przypadku faktur, o których mowa w art. 106f
                ust. 3 ustawy, należy wykazać pełne wartości zamówienia
                lub umowy. W przypadku faktur korygujących pozycje
                faktury (w tym faktur korygujących faktury, o których
                mowa w art. 106f ust. 3 ustawy, jeśli korekta dotyczy
                wartości zamówienia) należy wykazać różnice wynikające z
                korekty poszczególnych pozycji lub dane pozycji
                korygowanych wg stanu przed korektą i po korekcie jako
                osobne wiersze. W przypadku faktur korygujących faktury,
                o których mowa w art. 106f ust. 3 ustawy, jeśli korekta
                nie dotyczy wartości zamówienia i jednocześnie zmienia
                wysokość podstawy opodatkowania lub podatku, należy
                wprowadzić zapis wg stanu przed korektą i zapis wg stanu
                po korekcie w celu potwierdzenia braku zmiany wartości
                danej pozycji faktury
            ...
            zamowienie: Zamówienie lub umowa, o których mowa w art. 106f
                ust. 1 pkt 4 ustawy (dla faktur zaliczkowych), w
                walucie, w której wystawiono fakturę zaliczkową. W
                przypadku faktury korygującej fakturę zaliczkową należy
                wykazać różnice wynikające z korekty poszczególnych
                pozycji zamówienia lub umowy lub dane pozycji
                korygowanych wg stanu przed korektą i po korekcie jako
                osobne wiersze, jeśli korekta dotyczy wartości
                zamówienia lub umowy. W przypadku faktur korygujących
                faktury zaliczkowe, jeśli korekta nie dotyczy wartości
                zamówienia lub umowy i jednocześnie zmienia wysokość
                podstawy opodatkowania lub podatku, należy wprowadzić
                zapis wg stanu przed korektą i zapis wg stanu po
                korekcie w celu potwierdzenia braku zmiany wartości
                danej pozycji
        """
        ...
        p_6_or_okres_fa: None | str | Faktura.Fa.OkresFa = field(
            default=None,
            metadata={
                "type": "Elements",
                "choices": (
                    ...
                    {
                        "name": "OkresFa",
                        "type": ForwardRef("Faktura.Fa.OkresFa"),
                    },
                ),
            },
        )
        ...
        class Adnotacje:
            """
            Attributes:
                p_16: W przypadku dostawy towarów lub świadczenia usług,
                    w odniesieniu do których obowiązek podatkowy
                ...
                p_17: W przypadku faktur, o których mowa w art. 106d
                    ust. 1 ustawy - wyraz "samofakturowanie"; należy
                    podać wartość "1", w przeciwnym przypadku - wartość
                    "2"
                p_18: W przypadku dostawy towarów lub wykonania usługi,
                    dla których obowiązanym do rozliczenia podatku od
                    ...
                    przypadku - wartość "2"
                p_18_a: W przypadku faktur, w których kwota należności
                    ogółem przekracza kwotę 15 000 zł lub jej
                    równowartość wyrażoną w walucie obcej, obejmujących
                    dokonaną na rzecz podatnika dostawę towarów lub
                    świadczenie usług, o których mowa w załączniku nr 15
                    do ustawy - wyrazy "mechanizm podzielonej
                ...
                p_23: W przypadku faktur wystawianych w procedurze
                    uproszczonej przez drugiego w kolejności podatnika,
                    o którym mowa w art. 135 ust. 1 pkt 4 lit. b i c
                    oraz ust. 2 ustawy, zawierającej adnotację, o której
                    mowa w art. 136 ust. 1 pkt 1 ustawy i stwierdzenie,
                    o którym mowa w art. 136 ust. 1 pkt 2 ustawy, należy
                    podać wartość "1", w przeciwnym przypadku - wartość
                    "2"
                pmarzy:
            """
            ...
            class Zwolnienie:
                choice: list[
                    Faktura.Fa.Adnotacje.Zwolnienie.P19
                    | Faktura.Fa.Adnotacje.Zwolnienie.P19A
                    | Faktura.Fa.Adnotacje.Zwolnienie.P19B
                    | Faktura.Fa.Adnotacje.Zwolnienie.P19C
                    | Faktura.Fa.Adnotacje.Zwolnienie.P19N
                ] = field(
                    default_factory=list,
                    metadata={
                        "type": "Elements",
            ...
            class NoweSrodkiTransportu:
                choice: list[
                    Faktura.Fa.Adnotacje.NoweSrodkiTransportu.P22
                    | Twybor12
                    | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu
                    | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.P22N
                ] = field(
                    default_factory=list,
                    metadata={
                        "type": "Elements",
                ...
                class NowySrodekTransportu:
                    """
                    Attributes:
                        p_22_a: Data dopuszczenia nowego środka
                            transportu do użytku
                        p_nr_wiersza_nst: Numer wiersza faktury, w
                            którym wykazano dostawę nowego środka
                            transportu
                        p_22_bmk: Marka nowego środka transportu
                        p_22_bmd: Model nowego środka transportu
                        p_22_bk: Kolor nowego środka transportu
                        p_22_bnr: Numer rejestracyjny nowego środka
                            transportu
                    ...
                    choice: list[
                        Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22B
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22B1
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22B2
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22B3
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22B4
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22Bt
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22C
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22C1
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22D
                        | Faktura.Fa.Adnotacje.NoweSrodkiTransportu.NowySrodekTransportu.P22D1
                    ] = field(
                        default_factory=list,
                        metadata={
                            "type": "Elements",
            ...
            class Pmarzy:
                choice: list[
                    Faktura.Fa.Adnotacje.Pmarzy.PPmarzy
                    | Faktura.Fa.Adnotacje.Pmarzy.PPmarzy2
                    | Faktura.Fa.Adnotacje.Pmarzy.PPmarzy31
                    | Faktura.Fa.Adnotacje.Pmarzy.PPmarzy32
                    | Faktura.Fa.Adnotacje.Pmarzy.PPmarzy33
                    | Faktura.Fa.Adnotacje.Pmarzy.PPmarzyN
                ] = field(
                    default_factory=list,
                    metadata={
                        "type": "Elements",
        ...
        class ZaliczkaCzesciowa:
            """
            Attributes:
                p_6_z: Data otrzymania płatności, o której mowa w art.
                    106b ust. 1 pkt 4 ustawy
                p_15_z: Kwota płatności, o której mowa w art. 106b ust.
                    1 pkt 4 ustawy, składająca się na kwotę w polu P_15.
                    W przypadku faktur korygujących - korekta kwoty
                    wynikającej z faktury korygowanej
                kurs_waluty_zw: Kurs waluty stosowany do wyliczenia
                    kwoty podatku w przypadkach, o których mowa w dziale
                    VI ustawy
            """
        ...
        class FakturaZaliczkowa:
            nr_kse_fzn_or_nr_fa_zaliczkowej_or_nr_kse_ffa_zaliczkowej: list[
                Twybor1
                | Faktura.Fa.FakturaZaliczkowa.NrFaZaliczkowej
        ...
        class FaWiersz:
            ...
            Attributes:
                ...
                p_6_a: Data dokonania lub zakończenia dostawy towarów
                    lub wykonania usługi lub data otrzymania zapłaty, o
                    której mowa w art. 106b ust. 1 pkt 4 ustawy, o ile
                    taka data jest określona i różni się od daty
                    wystawienia faktury. Pole wypełnia się w przypadku
                    gdy dla poszczególnych pozycji faktury występują
                    różne daty
                p_7: Nazwa (rodzaj) towaru lub usługi. Pole opcjonalne
                    wyłącznie dla przypadku określonego w art 106j ust.
                    3 pkt 2 ustawy (faktura korygująca)
                indeks: Pole przeznaczone do wpisania wewnętrznego kodu
                ...
                p_8_a: Miara dostarczonych towarów lub zakres wykonanych
                    usług. Pole opcjonalne dla przypadku określonego w
                ...
                p_9_a: Cena jednostkowa towaru lub usługi bez kwoty
                    podatku (cena jednostkowa netto). Pole opcjonalne
                    dla przypadków określonych w art. 106e ust. 2 i 3
                    oraz ust. 5 pkt 3 ustawy
                p_9_b: Cena wraz z kwotą podatku (cena jednostkowa
                    brutto), w przypadku zastosowania art. 106e ust. 7 i
                    8 ustawy
                p_10: Kwoty wszelkich opustów lub obniżek cen, w tym w
                    formie rabatu z tytułu wcześniejszej zapłaty, o ile
                    nie zostały one uwzględnione w cenie jednostkowej
                    netto, a w przypadku stosowania art. 106e ust. 7
                    ustawy w cenie jednostkowej brutto. Pole opcjonalne
                    dla przypadków określonych w art. 106e ust. 2 i 3
                    oraz ust. 5 pkt 1 ustawy
                p_11: Wartość dostarczonych towarów lub wykonanych
                    usług, objętych transakcją, bez kwoty podatku
                    (wartość sprzedaży netto). Pole opcjonalne dla
                    przypadków określonych w art. 106e ust. 2 i 3 oraz
                    ust. 5 pkt 3 ustawy
                p_11_a: Wartość sprzedaży brutto, w przypadku
                    zastosowania art. 106e ust. 7 i 8 ustawy
                p_11_vat: Kwota podatku w przypadku, o którym mowa w
                    art. 106e ust. 10 ustawy
                p_12: Stawka podatku. Pole opcjonalne dla przypadków
                    określonych w art. 106e ust. 2, 3, ust. 4 pkt 3 i
                    ust. 5 pkt 3 ustawy
                p_12_xii: Stawka podatku od wartości dodanej w
                    przypadku, o którym mowa w dziale XII w rozdziale 6a
                    ustawy
                p_12_zal_15: Znacznik dla towaru lub usługi wymienionych
                    w załączniku nr 15 do ustawy - wartość "1"
                kwota_akcyzy: Kwota podatku akcyzowego zawarta w cenie
                    towaru
                gtu: Oznaczenie dotyczące dostawy towarów i świadczenia
                    usług
                procedura: Oznaczenie dotyczące procedury
                kurs_waluty: Kurs waluty stosowany do wyliczenia kwoty
                    podatku w przypadkach, o których mowa w dziale VI
                    ustawy
                stan_przed: Znacznik stanu przed korektą w przypadku
                    ...
                    pozycjach faktury i jest dokonywana w sposób
                    polegający na wykazaniu danych przed korektą i po
                    korekcie jako osobnych wierszy z odrębną numeracją
                    oraz w przypadku potwierdzania braku zmiany wartości
                    danej pozycji
            """
        ...
        class Rozliczenie:
            ...
            do_zaplaty_or_do_rozliczenia: (
                ...
                | Faktura.Fa.Rozliczenie.DoRozliczenia
            ) = field(
                default=None,
                metadata={
                    "type": "Elements",
                    "choices": (
                        {
                            "name": "DoZaplaty",
                            "type": ForwardRef("Faktura.Fa.Rozliczenie.DoZaplaty"),
                        },
                        {
                            "name": "DoRozliczenia",
                            "type": ForwardRef("Faktura.Fa.Rozliczenie.DoRozliczenia"),
                        },
                    ),
                },
            )
            ...
            class Obciazenia:
                """
                Attributes:
                    kwota: Kwota doliczona do kwoty wykazanej w polu
                        P_15
            ...
            class Odliczenia:
                """
                Attributes:
                    kwota: Kwota odliczona od kwoty wykazanej w polu
                        P_15
        ...
        class Platnosc:
            ...
            Attributes:
                ...
                ipkse_f: Identyfikator płatności Krajowego Systemu
                    e-Faktur
            """

            choice: list[
                Twybor1 | str | Twybor12 | Faktura.Fa.Platnosc.ZaplataCzesciowa
            ] = field(
                default_factory=list,
                metadata={
                    "type": "Elements",
                    "choices": (
                        ...
                        },
                        {
                            ...
                            "type": ForwardRef("Faktura.Fa.Platnosc.ZaplataCzesciowa"),
                            "max_occurs": 100,
                        },
                    ),
                    "max_occurs": 101,
            ...
            forma_platnosci_or_platnosc_inna_or_opis_platnosci: list[
                TformaPlatnosci | Twybor1 | str
            ] = field(
                default_factory=list,
                metadata={
                    "type": "Elements",
            ...
            class Skonto:
                """
                Attributes:
                    warunki_skonta: Warunki, które nabywca powinien
            ...
            class ZaplataCzesciowa:
                ...
                Attributes:
                    ...
                    data_zaplaty_czesciowej: Data zapłaty częściowej,
        ...
        class WarunkiTransakcji:
            ...
            Attributes:
                ...
                warunki_dostawy: Warunki dostawy towarów - w przypadku
                    istnienia pomiędzy stronami transakcji, umowy
                    określającej warunki dostawy tzw. Incoterms
                kurs_umowny: Kurs umowny - w przypadkach, gdy na
                    fakturze znajduje się informacja o kursie, po którym
                    zostały przeliczone kwoty wykazane na fakturze w
                    złotych. Nie dotyczy przypadków, o których mowa w
                    dziale VI ustawy
                waluta_umowna: Waluta umowna - kod waluty (ISO-4217) w
                    przypadkach gdy na fakturze znajduje się informacja
                    o kursie, po którym zostały przeliczone kwoty
                    wykazane na fakturze w złotych. Nie dotyczy
                    przypadków, o których mowa w dziale VI ustawy
                transport:
                podmiot_posredniczacy: Wartość "1" oznacza dostawę
                    dokonaną przez podmiot, o którym mowa w art. 22 ust.
                    2d ustawy. Pole dotyczy przypadku, w którym podmiot
                    uczestniczy w transakcji łańcuchowej innej niż
                    procedura trójstronna uproszczona, o której mowa w
                    art. 135 ust. 1 pkt 4 ustawy
            """
            ...
            class Transport:
                """
                Attributes:
                    rodzaj_transportu_or_transport_inny_or_opis_innego_transportu:
                    przewoznik:
                    nr_zlecenia_transportu: Numer zlecenia transportu
                    opis_ladunku_or_ladunek_inny_or_opis_innego_ladunku:
                    jednostka_opakowania: Jednostka opakowania
                    data_godz_rozp_transportu: Data i godzina
                        rozpoczęcia transportu
                    data_godz_zak_transportu: Data i godzina zakończenia
                        transportu
                    wysylka_z: Adres miejsca wysyłki
                    wysylka_przez: Adres pośredni wysyłki
                    wysylka_do: Adres miejsca docelowego, do którego
                        został zlecony transport
                """

                rodzaj_transportu_or_transport_inny_or_opis_innego_transportu: list[
                    TrodzajTransportu | Twybor1 | str
                ] = field(
                    default_factory=list,
                    metadata={
                        "type": "Elements",
                ...
                opis_ladunku_or_ladunek_inny_or_opis_innego_ladunku: list[
                    Tladunek | Twybor1 | str
                ] = field(
                    default_factory=list,
                    metadata={
                        "type": "Elements",
                ...
                class Przewoznik:
                    """
                    Attributes:
                        dane_identyfikacyjne: Dane identyfikacyjne
                            przewoźnika
        ...
        class Zamowienie:
            ...
            Attributes:
                ...
                zamowienie_wiersz: Szczegółowe pozycje zamówienia lub
                    umowy w walucie, w której wystawiono fakturę
                    zaliczkową
            """
            ...
            class ZamowienieWiersz:
                """
                Attributes:
                    nr_wiersza_zam: Kolejny numer wiersza zamówienia lub
                        umowy
                    uu_idz: Uniwersalny unikalny numer wiersza
                        zamówienia lub umowy
                    p_7_z: Nazwa (rodzaj) towaru lub usługi
                    indeks_z: Pole przeznaczone do wpisania wewnętrznego
                        kodu towaru lub usługi nadanego przez podatnika
                        albo dodatkowego opisu
                    gtinz: Globalny numer jednostki handlowej
                    pkwi_uz: Symbol Polskiej Klasyfikacji Wyrobów i
                        Usług
                    cnz: Symbol Nomenklatury Scalonej
                    pkobz: Symbol Polskiej Klasyfikacji Obiektów
                        Budowlanych
                    ...
                    p_11_netto_z: Wartość zamówionego towaru lub usługi
                        bez kwoty podatku
                    p_11_vat_z: Kwota podatku od zamówionego towaru lub
                        usługi
                    p_12_z: Stawka podatku
                    p_12_z_xii: Stawka podatku od wartości dodanej w
                        przypadku, o którym mowa w dziale XII w
                        rozdziale 6a ustawy
                    p_12_z_zal_15: Znacznik dla towaru lub usługi
                        wymienionych w załączniku nr 15 do ustawy -
                        wartość "1"
                    gtuz: Oznaczenie dotyczące dostawy towarów i
                        świadczenia usług
                    procedura_z: Oznaczenia dotyczące procedur
                    kwota_akcyzy_z: Kwota podatku akcyzowego zawarta w
                        cenie towaru
                    stan_przed_z: Znacznik stanu przed korektą w
                        przypadku faktury korygującej fakturę
                        dokumentującą otrzymanie zapłaty lub jej części
                        przed dokonaniem czynności oraz fakturę
                        wystawioną w związku z art. 106f ust. 4 ustawy
                        (faktura korygująca fakturę zaliczkową), w
                        przypadku gdy korekta dotyczy danych wykazanych
                        w pozycjach zamówienia i jest dokonywana w
                        sposób polegający na wykazaniu danych przed
        ...
        class DaneFaKorygowanej:
            """
            Attributes:
                data_wyst_fa_korygowanej: Data wystawienia faktury
                    korygowanej
                nr_fa_korygowanej: Numer faktury korygowanej
                nr_kse_f_or_nr_kse_ffa_korygowanej_or_nr_kse_fn:
            """
            ...
            nr_kse_f_or_nr_kse_ffa_korygowanej_or_nr_kse_fn: list[
                Faktura.Fa.DaneFaKorygowanej.NrKseF
                | str
                | Faktura.Fa.DaneFaKorygowanej.NrKseFn
            ] = field(
                default_factory=list,
                metadata={
                    "type": "Elements",
                    "choices": (
                        {
                            "name": "NrKSeF",
                            "type": ForwardRef("Faktura.Fa.DaneFaKorygowanej.NrKseF"),
                        },
                        {
                        ...
                        {
                            "name": "NrKSeFN",
                            "type": ForwardRef("Faktura.Fa.DaneFaKorygowanej.NrKseFn"),
                        },
                    ),
                    "max_occurs": 2,
                },
        ...
        class Podmiot1K:
            ...
            Attributes:
                prefiks_podatnika: Kod (prefiks) podatnika VAT UE dla
                    przypadków określonych w art. 97 ust. 10 pkt 2 i 3
                    ustawy oraz w przypadku, o którym mowa w art. 136
                    ust. 1 pkt 3 ustawy
                dane_identyfikacyjne: Dane identyfikujące podatnika
                adres: Adres podatnika
            """
        ...
        class Podmiot2K:
            ...
            Attributes:
                ...
                adres: Adres nabywcy. Pola opcjonalne dla przypadków
                    określonych w art. 106e ust. 5 pkt 3 ustawy
                idnabywcy: Unikalny klucz powiązania danych nabywcy na
                    fakturach korygujących, w przypadku gdy dane nabywcy
                    na fakturze korygującej zmieniły się w stosunku do
                    danych na fakturze korygowanej
            """
