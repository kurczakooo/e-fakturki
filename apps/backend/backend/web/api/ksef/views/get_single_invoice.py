...
from ksef_client.models import InvoiceContent
...
from backend.web.api.ksef.services import get_auth_certs
...
@router.post("/ksef/single_download", status_code=202)
async def download_invoice_from_ksef(
    company_id: int = Form(...),
    ksef_reference_number: str = Form(...),
    db_session: AsyncSession = Depends(get_db_session),
) -> InvoiceContent:
    """Download single invoice xml from KSeF."""
